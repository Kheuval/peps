...
<head>
    ...
    <title><?= Cfg::get('appTitle') ?> | Inscription</title>
</head>
...
<body>
    ...
    <main>
        ...
        <form name="form1" action="/user/save" method="POST">
            ...
            <div class="item">
                <label>Email</label>
                <input type="email" name="email" value="<?= $user->email ?>" size="25" maxlength="50" required="required" />
            </div>
            <div class="item">
            ...
            <div class="item">
                <label></label>
                <input name="submit" type="submit" value="Inscription" disabled/>
            </div>
        </form>
    </main>
    <footer>
